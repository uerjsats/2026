...
// ------- PINS DO HARDWARE -------
// ===========================================
#define IN1 5         // Pino de controle 1 do driver de motor  para a roda de reacao(PWM)
#define IN2 6            // Pino de controle 2 do driver de motor (PWM)para a roda de reacao(PWM)
...
#define ANTIN1 11 // IN1 Pino de controle 1 do driver de motor da Antena
#define ANTIN2 10 // IN2 Pino de controle 1 do driver de motor
